    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        qosTestsSummaryViewModel.state.apply {
            ...
            this.categoryDescription.set(
                arguments?.getString(KEY_QOS_CATEGORY_DESCRIPTION) ?: throw IllegalStateException("Please pass category description")
            )
        ...
        qosTestSummaryAdapter.actionCallback = {
            ...
            val fragment =
                QosTestDetailPagerFragment.newInstance(qosTestsSummaryViewModel.state.testUUID, qosTestsSummaryViewModel.state.category, it)
