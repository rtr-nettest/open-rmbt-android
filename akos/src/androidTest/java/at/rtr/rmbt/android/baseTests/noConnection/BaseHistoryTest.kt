...
package at.rtr.rmbt.android.baseTests.noConnection
...
open class BaseHistoryTest : BaseHomeActivityTest() {
    ...
    internal fun pressOkOnErrorMessage() {
        if (!isConnected(activityRule.activity)) {
            Espresso.onView(ViewMatchers.withText(R.string.input_setting_dialog_ok))
