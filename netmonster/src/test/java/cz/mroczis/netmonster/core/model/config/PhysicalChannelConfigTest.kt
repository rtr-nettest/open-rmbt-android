...
class PhysicalChannelConfigTest : FreeSpec() {
    ...
    init {
        ...
        "Parsing, Android Q" {
            ...
            val primaryRaw =
                "{mConnectionStatus=PrimaryServing,mCellBandwidthDownlinkKhz=10000,mRat=0,mFrequencyRange=-1,mChannelNumber=2147483647,mContextIds=[I@2c4d2e6,mPhysicalCellId=2147483647}"
            val secondaryRaw =
                "{mConnectionStatus=SecondaryServing,mCellBandwidthDownlinkKhz=10000,mRat=0,mFrequencyRange=-1,mChannelNumber=2147483647,mContextIds=[I@9f41027,mPhysicalCellId=2147483647}"
